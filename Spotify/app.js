...
//The getToken function uses the Client Credentials flow, one of the Spotify Web API authorization flows. 
const getToken = async () => {
  // pause the execution of the function until a Promise is resolved or rejected
  //The function then sends a fetch request to the Spotify Accounts service (https://accounts.spotify.com/api/token) using the HTTP POST method.
